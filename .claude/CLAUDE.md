...
When adding translation strings, only add the English translation to the `en_US` translation file. Do not attempt to translate the English strings into other languages, and do not add empty `""` strings to the other language files.
